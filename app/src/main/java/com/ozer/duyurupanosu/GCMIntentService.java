...
import static com.ozer.duyurupanosu.Settings.GCM_SENDER_ID;
...
public class GCMIntentService extends GCMBaseIntentService {
  ...
  protected void onRegistered(Context context, String registrationId) {
    ...
    //todo displayMessage(context, getString(R.string.gcm_registered, registrationId));
   // Toast.makeText(context, "Cihaz Kaydedildi", Toast.LENGTH_SHORT).show();
  ...
  private static void generateNotification(Context context, String message) {
    ...
    Notification notification = new NotificationCompat.Builder(context)
    	...
    	.setContentTitle("Yeni bir duyurunuz var!!!")
